...
# require requires the full path to the file
...
# calls two other methods
  ...
  private
# outputs different results depending on population density
...
# depending on population density will output different speeds 
...
STATE_DATA.each do |state,data| 
  solution = VirusPredictor.new(state,data[:population_density], data[:population])
  solution.virus_effects
end
#=======================================================================
# Reflection Section
